...
public class LoopQueueCommand extends MusicCommand implements NoArgsCommand {
    public LoopQueueCommand(Bot bot) {
        super(bot, "loopqueue", "Shows info on currently playing track if any", "lq");
    }
    ...
    public void execute(CommandReceivedEvent e) {
        ...
        MusicPlayer manager = PlayerManager.getPlayer(e);
